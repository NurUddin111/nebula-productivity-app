    ...
    <div className="p-3 md:p-4 border-t border-slate-700/50">
      ...
      >
        ...
        <button
          ...
          className={`shrink-0 bg-slate-800/50 text-slate-400 hover:text-slate-200 rounded-lg p-2 md:px-4 transition-colors ${
        ...
        <button
          ...
          className="shrink-0 bg-linear-to-r from-cyan-500 to-cyan-600 text-white rounded-lg p-2 md:px-4 md:py-2 font-medium hover:from-cyan-600 hover:to-cyan-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
